# [Handuo](https://zhanghanduo.github.io)’s dotfiles [![Build Status](https://travis-ci.org/alrra/dotfiles.svg?branch=master)](https://travis-ci.org/alrra/dotfiles)
...
- [Handuo’s dotfiles ![Build Status](https://travis-ci.org/alrra/dotfiles)](#handuos-dotfiles-build-statushttpstravis-ciorgalrradotfiles)
...
understand [what it does](setup.sh). )
